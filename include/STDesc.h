...
typedef struct ConfigSetting {
    ...
    double vertex_diff_threshold_ = 0.5;
    double rough_dis_threshold_ = 0.015;
    double normal_threshold_ = 0.2;
    double dis_threshold_ = 0.5;
    double icp_threshold_ = 0.4;
...
public:
    ...
    std::vector<std::vector<STDesc>> std_vec_db_;
    ...
    void SearchLoop(const std::vector<STDesc> &stds_vec,
                    ...
                    pcl::PointCloud<pcl::PointXYZINormal>::Ptr src_node_plane_vec);
