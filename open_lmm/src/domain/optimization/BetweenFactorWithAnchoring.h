...
class BetweenFactorWithAnchoring
    : public NoiseModelFactor4<VALUE, VALUE, VALUE, VALUE> {
 ...
 public:
  ...
  BetweenFactorWithAnchoring(
      ...
      const VALUE& measured, const SharedNoiseModel& model = nullptr)
      : Base(model, key1, key2, anchor_key1, anchor_key2),
        measured_(measured) {}
  ...
  // isam ver. line 233,
  // https://people.csail.mit.edu/kaess/isam/doc/slam2d_8h_source.html
  /** vector of errors */
  Vector evaluateError(const T& p1, const T& p2, const T& anchor_p1,
                       const T& anchor_p2,
                       boost::optional<Matrix&> H1 = boost::none,
                       boost::optional<Matrix&> H2 = boost::none,
                       boost::optional<Matrix&> anchor_H1 = boost::none,
                       boost::optional<Matrix&> anchor_H2 = boost::none) const {
    // anchor node h(.) (ref: isam ver. line 233,
    // https://people.csail.mit.edu/kaess/isam/doc/slam2d_8h_source.html)
    T hx1 =
        traits<T>::Compose(anchor_p1, p1, anchor_H1,
                           H1);  // for the updated jacobian, see line 60, 219,
...
// traits
template <class VALUE>
struct traits<BetweenFactorWithAnchoring<VALUE> >
    : public Testable<BetweenFactorWithAnchoring<VALUE> > {};
...
//   BetweenConstraintGiseop(const VALUE& measured, Key key1, Key key2, double
//   mu = 1000.0) :
//     BetweenFactorWithAnchoring<VALUE>(key1, key2, measured,
//                          noiseModel::Constrained::All(traits<VALUE>::GetDimension(measured),
//                          std::abs(mu)))
//   {}
...
//         boost::serialization::base_object<BetweenFactorWithAnchoring<VALUE>
//         >(*this));
//   }
...
// /// traits
// template<class VALUE>
// struct traits<BetweenConstraintGiseop<VALUE> > : public
// Testable<BetweenConstraintGiseop<VALUE> > {};
