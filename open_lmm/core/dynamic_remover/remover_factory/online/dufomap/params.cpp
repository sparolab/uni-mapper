...
DUFOMapParams::DUFOMapParams() {
  ...
  down_sampling_method = config.param<std::string>("dynamic_remover", "down_sampling_method", "center");
  ...
  integration.miss_depth = config.param<int>("dynamic_remover", "miss_depth", 0);
  integration.max_range = config.param<double>("dynamic_remover", "max_range", 80.0);
  integration.inflate_unknown = config.param<double>("dynamic_remover", "inflate_unknown", 1);
  integration.inflate_unknown_compensation = config.param<bool>("dynamic_remover", "inflate_unknown_compensation", true);
  integration.ray_passthrough_hits = config.param<bool>("dynamic_remover", "ray_passthrough_hits", false);
  integration.inflate_hits_dist = config.param<double>("dynamic_remover", "inflate_hits_dist", 0.2);
  simple_ray_casting = config.param<bool>("dynamic_remover", "simple_ray_casting", false);
  ...
  integration.simple_ray_casting_factor = config.param<double>("dynamic_remover", "simple_ray_casting_factor", 1.0);
