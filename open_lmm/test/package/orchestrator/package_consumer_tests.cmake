...
file(COPY "${OPEN_LMM_SOURCE_DIR}/test/package/consumers/"
     DESTINATION "${consumer_source}")
file(COPY
  "${OPEN_LMM_SOURCE_DIR}/test/package/manifests/public_header_allowlist.txt"
  "${OPEN_LMM_SOURCE_DIR}/test/package/manifests/exported_target_allowlist.txt"
  "${OPEN_LMM_SOURCE_DIR}/test/package/manifests/header_component_manifest.tsv"
  DESTINATION "${consumer_source}")
